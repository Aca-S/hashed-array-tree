...
Iako je iskorišćenost alocirane memorije asimptotski bolja u slučaju stabla nizova nego u slučaju standardnog dinamičkog niza, treba imati u vidu da je u stablu nizova u svakom trenutku potrebno dodatni niz, tj. koren stabla, veličine $O(\sqrt{size})$.
